<%-- 
    Document   : Login
    Created on : Jul 1, 2019, 10:47:02 PM
    Author     : prabe
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid rounded border" style="width: 400px; padding-top: 50px; padding-bottom: 50px;
             margin-top: 50px; margin-bottom: 50px; background-color: #FAFBFB">
            <form>
