...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="margin-top: 15px">
            <% while(res.next()){ %>
                <div class="card" style="width: 13rem; height: 28rem; float: left; margin-right: 10px">
                    <img class="card-img-top" src="../Photos/<%=res.getString(6)%>" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title"><%=res.getString(2)%></h5>
                        <p class="card-text">Price: Rs. <%=res.getString(4)%></p>
                        <a href="OrderProduct.jsp" class="btn btn-primary">View Info</a>
                    </div>
                </div>
            <%}%>
        </div>
